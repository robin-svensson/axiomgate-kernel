...
suite runs in a fresh virtual environment containing nothing else — 371 passed,
...
Version 0.10.0. The code is mature — 371 tests, mutation-tested protections — but
